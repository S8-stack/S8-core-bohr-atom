 ...
 *
 */
public class Int8NeMethodRunner extends NeMethodRunner {
	...
	public Int8NeMethodRunner(NeObjectTypeHandler prototype, String name, int ordinal) {
	...
	public void run(NeBranch branch, ByteInflow inflow, Object lambda) throws IOException {
		...
		((NeObject.Int8Lambda) lambda).operate(arg);
	}
}
