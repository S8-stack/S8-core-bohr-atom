 ...
 *
 */
public class Int32NeMethodRunner extends NeMethodRunner {
	...
	public Int32NeMethodRunner(NeObjectTypeHandler prototype, String name, int ordinal) {
	...
	public void run(NeBranch branch, ByteInflow inflow, Object lambda) throws IOException {
		...
		((NeObject.Int32Lambda) lambda).operate(arg);
	}
}
