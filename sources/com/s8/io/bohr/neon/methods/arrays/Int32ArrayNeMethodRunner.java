...
import com.s8.io.bohr.neon.core.NeObject.UInt32ArrayLambda;
 ...
 * 
 */
public class Int32ArrayNeMethodRunner extends NeMethodRunner {
	 ...
	 * @param name
	 */
	public Int32ArrayNeMethodRunner(NeObjectTypeHandler prototype, String name) {
	...
	public void run(NeBranch branch, ByteInflow inflow, Object lambda) throws IOException {
		...
		((UInt32ArrayLambda) lambda).operate(arg);
	}
}
