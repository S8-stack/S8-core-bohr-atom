 ...
 * 
 */
public class LiIOException extends IOException {
	...
	public LiIOException(String message) {
		super(message);
	}
	 ...
	 * @param type
	 */
	public LiIOException(String message, Class<?> type) {
	 ...
	 * @param type
	 */
	public LiIOException(String message, Class<?> type, Exception cause) {
	...
	public LiIOException(String message, Field field, Exception cause) {
	...
	public LiIOException(String message, Method method, Exception cause) {
