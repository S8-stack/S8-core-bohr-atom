...
public interface S8Graph {
	 ...
	 * @throws S8Exception 
	 */
	public void expose(int port, LiS8Object object);
	 ...
	 * @throws S8Exception 
	 */
	public <T extends LiS8Object> T access(int port) throws S8Exception;
	 ...
	 * @throws S8Exception 
	 */
	public void attach(LiS8Object object) throws S8Exception;
